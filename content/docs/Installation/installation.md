...
{{< tabs items="Weak-coupling,Continuation" >}}

{{< tab >}}
### Weak-coupling Many-Body Perturbation theory solver

1. Prerequisites: Please make sure to have the following third-party software installed and available:
...
2. Prerequisites: Please make sure to have python and the following python packages available:
...
3. The following instructions will download and build the Many-Body Perturbation theory solver (replace /path/to/install/directory with the directory where you'd like to install the code):
...
4. The code has been tested on the following national-wide HPC resources:
...
2. The following instructions will download and build the Analytical Continuation package (replace /path/to/install/directory with the directory where you'd like to install the code):
